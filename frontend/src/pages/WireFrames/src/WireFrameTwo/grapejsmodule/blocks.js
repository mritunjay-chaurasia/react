export default function(editor, opts) {
  ...
  addBlock("sect100", {
    ...
    content: `
    <section>
        <div style="max-height:100rem; max-width:100rem;">
  ...
  addBlock("button", {
    ...
    content: '<button style="max-height:100rem; max-width:100rem;" >Button</button>'
  })
  ...
  addBlock("input", {
    ...
    content: '<input type="text" placeholder="Placeholder" style="max-height:100rem; max-width:100rem; margin-bottom: 15px; padding: 15px; border: 1px solid rgb(204, 204, 204); border-radius: 5px;">'
  })
  ...
  addBlock("divider", {
    ...
    content: `
      <p style="height: 1px;; background-color: rgba(0, 0, 0, 0.1);margin-top: 10px; margin-bottom: 10px;"></p>
    `
  })
  ...
  addBlock("text", {
    ...
    content: {
      ...
      style: { padding: "10px",maxHeight:"100rem",maxWidth:"100rem" }
    }
  })
  ...
  addBlock("link", {
    ...
    content: {
      type: "link",
      content: "Link",
      style: { color: "#3b97e3",maxHeight:"100rem",maxWidth:"100rem" }
    }
  })
